...
public class SaveInformationDAO {
    public int saveFileHistory(int userId, Timestamp currentTime, String fileName, String finalOutputDocx,
            String status) {
    ...
    public List<information> getFileHistory(int userId) {
        ...
        try (Connection connection = ConnectDB.connectDatabase()) {
            String query = "SELECT * FROM information WHERE UserID = ? AND (Status = 'Success' OR Status = 'Processing') ORDER BY DateConvert DESC";
